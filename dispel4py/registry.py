...
import traceback
import json
from dispel4py import utils, GenericPE, workflow_graph
...
class VerceRegistry(object):
    ...
    def register_function(self, fullname, functionName, path):
        ...
        funAnn = workflow_graph.extractAnnotations(funImpl)
    ...
    def register_pe(self, fullname, className, path):   
        ...
        for conx in peImpl.inputconnections.values():
            connection = {}
            connection["name"] = conx[GenericPE.NAME]
            connection["kind"] = 0
