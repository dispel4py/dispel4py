...
class SourceWrapper(storm.Spout):
    ...
    def initialize(self, conf, context):
        try:
            ...
            for outputname, output\
                    in self.script.outputconnections.iteritems():
            ...
            storm.log("Dispel4Py ------> %s: %s"
                      % (self.scriptname, traceback.format_exc(),))
            raise
    ...
    def nextTuple(self):
        try:
            ...
            for streamname, output in outputs.iteritems():
                ...
                storm.log("Dispel4Py ------> %s: emitted tuple %s to stream %s"
