...
if __name__ == '__main__':
   ...
   functionName = "eu.verce.test.TestFunction1"
   try:
   ...
   try:
       reg.register_pe('eu.verce.test.Filter', 'RandomFilter', 'eu/verce/test/TestPEs.py')
   except: 
       print "Couldn't register eu.verce.test.RandomFilter"
    
   try:
       reg.register_pe('eu.verce.test.RandomWordProducer', 'RandomWordProducer', 'eu/verce/test/TestPEs.py')
   except:
       print "Couldn't register eu.verce.test.RandomWordProducer"
